...
const createReadingListController = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const readingList = req.body;
    const result =
      yield readingList_service_1.ReadingListService.createReadingList(
        readingList,
      );
...
const getReadingListController = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
      yield readingList_service_1.ReadingListService.getReadingList();
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
