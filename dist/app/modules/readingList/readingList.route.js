...
router.post('/', (0, validateRequest_1.default)(readingList_validation_1.ReadingListValidation.createReadingListZodSchema), (0, auth_1.default)(user_1.ENUM_USER_ROLE.USER), readingList_controller_1.ReadingListController.createReadingListController);
